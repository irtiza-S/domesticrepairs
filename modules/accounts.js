...
export async function register(data) {
	...
	const sql = `INSERT INTO accounts(user, pass, locationLongitude, locationLatitude) VALUES("${data.username}", "${password}", "${data.locationLongitude}", "${data.locationLatitude}")`
	console.log(sql)
